...
export class Age2Component implements OnInit {
  ...
  updateMetaTags(){
    this.title.setTitle("Age 2 | All you need to know about Speech Development & flashcards");
    ...
    this.meta.updateTag(  {property : "og:title", content: "Age 2 | All you need to know about Speech Development & flashcards"});
  }
