...
export class Age4Component implements OnInit {
  ...
  updateMetaTags(){
    ...
    this.meta.updateTag(  {property : "og:url", content: "https://omishaan.com/age4speechdevelopment"});
    this.meta.updateTag(  {property : "og:image", content: "https://omishaan.com/assets/img/age4speechbanner.png"});
