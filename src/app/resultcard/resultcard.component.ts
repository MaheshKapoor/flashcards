...
export class ResultcardComponent implements OnInit {
  ...
  fbShare() {
    /// let url = 'http://www.facebook.com/sharer.php?u='+ 'https://omishaan.com/quiz/DKTNSW00E181003020';
    let url ="http://www.facebook.com/dialog/feed?app_id=694150900972156&display=popup&link=https://omishaan.com/quiz/"+localStorage.getItem("id");
