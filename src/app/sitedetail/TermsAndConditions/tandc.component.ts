...
export class TandCComponent implements OnInit {
  ...
  updateMetaTags() {
    this.title.setTitle("Terms and Conditions - Omishaan Flashcards");
    this.meta.updateTag({
      name: "description",
      content: "Terms and Conditions - Omishaan Flashcards"
    });
    this.meta.updateTag({
      name: "keywords",
    ...
    this.meta.updateTag({property: "og:url", content: "https://omishaan.com/termsandconditions"});
    this.meta.updateTag({property: "og:image", content: "https://omishaan.com/assets/img/age2speechbanner.png"});
    this.meta.updateTag({
      property: "og:description",
      content: "Terms and Conditions - Omishaan Flashcards"
    });
    this.meta.updateTag({property: "og:title", content: "Terms and Conditions - Omishaan Flashcards"});
  }
